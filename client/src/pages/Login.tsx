    ...
    <div className="flex items-center justify-center min-h-[70vh]">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-400 text-sm">Enter your credentials to enter the Arena</p>
        </div>
        ...
        <div className="relative flex py-2 items-center text-gray-500">
          <div className="flex-grow border-t border-white/10"></div>
          <span className="flex-shrink mx-4 text-xs font-semibold uppercase">Or</span>
          <div className="flex-grow border-t border-white/10"></div>
        </div>
        ...
        <button
          ...
          type="button"
          className="w-full btn-secondary border border-white/20 hover:bg-white/5 py-2.5 flex items-center justify-center gap-2"
        >
        ...
        <p className="text-center text-sm text-gray-400">
          New user?{' '}
          <Link to="/register" className="text-purple-primary hover:underline font-semibold">
            Register Account
          </Link>
        </p>
      </motion.div>
